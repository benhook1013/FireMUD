...
class ScriptScheduleDefinitionServiceImplTest {
  ...
  private static Stream<Arguments> invalidTimerCadenceValues() {
    return Stream.of(
        ...
        Arguments.of("delayTicks", "0", false),
        Arguments.of("delayTicks", "null", false),
        Arguments.of("delayTicks", "true", false),
        ...
        Arguments.of("delayMs", "0", false),
        Arguments.of("delayMs", "null", false),
        Arguments.of("delayMs", "true", false),
