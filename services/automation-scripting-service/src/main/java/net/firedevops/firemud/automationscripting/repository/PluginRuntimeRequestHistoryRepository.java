...
public class PluginRuntimeRequestHistoryRepository {
  ...
  private void populate(
    ...
    record.setRequestOutcome(entity.getRequestOutcome());
  ...
  private PluginRuntimeRequestHistory toEntity(Record record) {
    ...
    entity.setRequestOutcome(record.get(PLUGIN_RUNTIME_REQUEST_HISTORY.REQUEST_OUTCOME));
    entity.setFailureCode(record.get(PLUGIN_RUNTIME_REQUEST_HISTORY.FAILURE_CODE));
