-- V6/V7 add these checks without immediate row validation so constraint installation does not hold a
-- validation-strength lock while older rows are scanned. Validate them separately
