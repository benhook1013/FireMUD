...
-- These columns are already consumed by the resolved scheduler/handoff persistence
-- paths; add them in the same additive migration so generated jOOQ code has one
-- coherent schema for every durable plugin execution boundary.
