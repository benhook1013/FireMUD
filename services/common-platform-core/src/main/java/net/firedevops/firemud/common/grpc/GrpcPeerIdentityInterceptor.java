 ...
 *
 * <p>Identity extraction is intentionally non-blocking for unrelated RPCs. A missing, ambiguous,
 * or malformed identity is represented as an absent context value; a protected handler must then
 * deny the call through its explicit method guard.
 */
