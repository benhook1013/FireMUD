...
All persistence invariants, versioning rules, and migration guidance for asset storage must be added only to the central design document referenced above, not here.
