#!/usr/bin/env bash
# Simple smoke test for World Management Service REST and gRPC endpoints
set -euo pipefail
...
resp=$(grpcurl -plaintext "$GRPC_ADDR" world_management.v1.WorldManagementService/Ping)
