...
ALTER TABLE gameplay_command
    ADD COLUMN source_script_patch_version character varying(128);
ALTER TABLE gameplay_command
    ADD COLUMN source_script_pin_epoch bigint;
ALTER TABLE gameplay_command
    ADD COLUMN source_script_pin_control_plane_request_id character varying(128);
ALTER TABLE gameplay_command
    ADD COLUMN target_script_patch_version character varying(128);
ALTER TABLE gameplay_command
    ADD COLUMN target_script_pin_epoch bigint;
ALTER TABLE gameplay_command
    ADD COLUMN target_script_pin_control_plane_request_id character varying(128);
