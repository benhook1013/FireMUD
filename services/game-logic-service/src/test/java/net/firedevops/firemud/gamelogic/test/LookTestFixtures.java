package net.firedevops.firemud.gamelogic.test;
...
public final class LookTestFixtures {
  ...
  public static ListRoomEntitiesResponse sampleEntities() {
    net.firedevops.firemud.entitymanagement.v1.RoomEntity kobold =
        net.firedevops.firemud.entitymanagement.v1.RoomEntity.newBuilder()
            ...
            .build();
    net.firedevops.firemud.entitymanagement.v1.RoomEntity player =
        net.firedevops.firemud.entitymanagement.v1.RoomEntity.newBuilder()
