...
- `preview/`
  ...
  - preview eligibility requires valid GitHub label metadata; `preview:paused` suppresses deploy, retain, and reconciliation while `preview:priority` remains unchanged when absent or when the preview is not paused
