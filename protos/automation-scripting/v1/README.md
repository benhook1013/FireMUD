...
- `ListScriptHandoffEvents` – per-command handoff history for durable work items, including `automationDispatchId`, target entity, Game Session command id, and handoff outcome/reason so richer multi-command output remains debuggable after handoff.
