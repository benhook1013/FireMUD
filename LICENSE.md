...
Benjamin James Hook is the current legal rights holder for FireMUD. FireDevOps is the project brand, and firedevops.net is its website; neither is a separate legal entity.
...
Commercial use is not permitted under this repository license. For commercial licensing inquiries, contact <licensing@firedevops.net>; commercial use requires a separate written agreement with Benjamin James Hook.
