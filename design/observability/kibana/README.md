...
- [player-incident-drilldown.json](./player-incident-drilldown.json) – Saved search targeting player-visible incidents; filters on `characterId`, `tenantId`, `traceId`, and service to help investigate login, session, and gameplay issues quickly.
