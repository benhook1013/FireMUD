...
- [player-experience.json](./player-experience.json) – Canonical player experience SLO dashboard with login success ratio, command end-to-end latency (p99), stage-split command latency drilldowns, fast-detection plus compliance views for Telnet/WebSocket path availability, and chat delivery latency (p99).
