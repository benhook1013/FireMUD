...
- When required proof cannot be produced truthfully, do not fabricate evidence or weaken or bypass its check. Keep the behavior blocked, or defer only the unproven part and record its owner, missing evidence, and reconsideration trigger.
