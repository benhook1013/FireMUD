...
- Delegate a bounded repository question likely to require several exploratory tool calls rather than spending main-thread context on unstructured search. Keep a single main-thread workflow unless a human asks otherwise.
