...
- Actor-state mutation, timed expiry processing, authored stat/condition definitions, shared effect evaluation, and equipment/action-state contributions remain future slices.
