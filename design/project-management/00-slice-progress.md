...
2. [02.18.2 Internal Blocking gRPC Auth Propagation](./vertical-slices/02.18.2-task-list-internal-grpc-auth-propagation-vertical-slice.md)
   Remaining: prove the hardened secured flows end to end and decide whether the remaining intentional raw-stub outliers should adopt the same seam or stay distinct.
