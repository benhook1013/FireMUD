...
- [ ] Consider adding a `game_registry` or `game_manifest` table for global coordination.
- [ ] Use publish events or polling to propagate version changes to runtime services.

### 📓 Documentation & Matrix Updates

- [ ] Update the **Responsibility Matrix** to reflect redistributed responsibilities.
- [ ] Update the **Architecture Document** to:
  - [ ] Remove mentions of `Game Management Service`.
  - [ ] Clarify versioning flow and runtime config ownership.
  - [ ] Expand description of `Game Session Service` responsibilities.
