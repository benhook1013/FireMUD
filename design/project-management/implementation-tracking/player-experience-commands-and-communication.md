...
- Communication scope/topology, speech-mode and audience-scope policy across tells, whispers, shouts, and map/region propagation, observer persistence and policy, offline messaging, and first-party recipient presentation in [04](../vertical-slices/04-task-list-chat-and-social-vertical-slice.md), [04.4](../vertical-slices/04.4-task-list-communication-observers-and-interceptors-vertical-slice.md), and [04.5](../vertical-slices/04.5-task-list-communication-recipient-delivery-vertical-slice.md).
