...
- **Sources / headings:** [ADR 0049](../../architecture/decisions/adr-0049-optional-provider-specific-external-identity-linking.md); [user-journeys-players.md](../../architecture/user-journeys-players.md) `§ 1. Sign Up` and `§ 7. Password Resets & Account Recovery`; [system-architecture-frontend.md](../../architecture/system-architecture-frontend.md) `§ Authentication and Session Handling`.
...
6. **P1 - Obtain product and policy decisions for `LIFE-01`, `PLAYTEST-01`, `PLAYER-01`, `SAFETY-01`, and `COMMERCE-01`.** Specifically resolve who may launch/cut over, whether revocation drains or ejects, character creation when descriptors are missing, moderation precedence and appeals, and refund entitlement reversal. For accepted `DATA-01`, collect implementation/readiness evidence for the export, billing-gated deletion, finite-retention, and terminal-erasure boundary, including deletion while subscriptions or tenant-owned data remain.
