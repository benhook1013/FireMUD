...
| --- | --- | --- | --- | --- |
| 1A | Identity, entitlement, and hosted terms | Cycle 10 productive; dry streak reset | [#2840](https://github.com/benhook1013/FireMUD/pull/2840) | The refreshed manifest adds the Account service owner README and current AA-1 ADRs to the recovered 17-source prompt, with named 5A, 1B, 5B/5D, 3A, 6A/6B/6C, platform, and billing handoffs. Cycles 1–8 were productive and Cycle 9 was dry (`16/1`, `24/1`, `18/1`, `33/1`, `13/1`, `17/1`, `47/3`, `28/3`, `15/0` raw/useful). The paired Cycle 10 found two P3 implementation-status defects: the shared-runtime tracker still described the now-disabled local subscription writer as active, and ADR 0028 still claimed current runtime blocked `past_due` despite the implemented accepted policy. Both status records now match code while preserving every unresolved provider, entitlement-evidence, freshness, retention, and consumer-proof gap. Cycle 10 was productive, so the dry streak resets to zero and Unit 1A has not tapered. |
