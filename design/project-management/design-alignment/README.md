...
| Accepted-decision application | In progress | `161` distinct decision keys have checked applied provenance; the four-decision Packet 6 tail and `17` Packet 7 decisions remain pending selective import |
| Contract-authority consolidation | Baseline pass complete for ADRs 0001-0050 and major adjacent non-ADR families; Packets 3-6 P0 and the first 11 Packet 6 P1 outcomes are selectively applied with family-local consolidation; continue with the four-decision Packet 6 tail and Packet 7, then perform the planned whole-corpus authority review | [Architecture contract authority map](../../architecture/README.md#contract-authority-map) and owner-link-plus-local-consequence conversions |
...
flowchart LR
    ...
    APPLY -->|merged to develop| APPLIED_DECISIONS[161 applied decision keys, including Packet 6 through MS-PO-OWNER-REMEDIATION and ADR 0165, plus owning design changes]:::status
...
This table describes merged repository state, not merely completed human review. The completed review archive remains source evidence; `161` of `182` distinct reviewed outcomes are selectively applied to `develop`. The four-decision Packet 6 tail and Packet 7 remain pending; the whole-corpus authority review follows completion of the selective-import program.
...
| Packet 6 P1 foundation, first 11 of 15 reviewed outcomes | Complete in the review archive | Checked provenance applied through `MS-PO-OWNER-REMEDIATION` and ADRs 0160-0165; `SCRIPT-14`, `SCRIPT-15`, `TRACE-02`, and `TRACE-03` remain pending | Family-local owner-link and local-consequence consolidation for observability, capacity, verification, and control availability | Implementation, calibration, and focused proof gaps remain explicit in the domain trackers; continue with the four-decision Packet 6 tail before Packet 7 |

## Contract Authority Consolidation Scope

Contract-authority consolidation applies to repeated normative product and architecture contracts whether or not an ADR records their rationale. ADRs organize the selective application process, but they are not the boundary of the deduplication work. PRs #2593 and #2594 complete the baseline pass for ADRs 0001-0050 and the major adjacent non-ADR contract families encountered across those design areas. Packets 3-6 P0 and the Packet 6 P1 foundation (ADRs 0051-0165 plus TICK-05) are selectively applied with family-local consolidation without redefining that baseline; the four-decision Packet 6 tail and Packet 7 remain pending.
