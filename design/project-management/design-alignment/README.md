...
| --- | --- | --- | --- | --- |
| 1A | Identity, entitlement, and hosted terms | Cycle 5 productive; taper not established | [#2840](https://github.com/benhook1013/FireMUD/pull/2840) | The refreshed manifest adds the Account service owner README and current AA-1 ADRs to the recovered 17-source prompt, with named 5A, 1B, 5B/5D, 3A, 6A/6B/6C, platform, and billing handoffs. Cycles 1–5 were productive (`16/1`, `24/1`, `18/1`, `33/1`, `13/1` raw/useful): they corrected realm-grant discovery without current admitting membership, the documented inactive-membership join target, Game Session's player-versus-instance-owner login check, the externally reachable caller-asserted identity-link route, and incomplete subscription creation that manufactured an active entitlement without caller-bound billing-owner or provider proof. That create path now fails closed before mutation. Known authority, lifecycle, replay, provider, and hosted-terms gaps remain routed. |
