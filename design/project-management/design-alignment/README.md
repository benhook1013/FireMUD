...
| 5B-Publication | Durable version/publication/readiness state | Four-cycle review boundary reached; corrected candidate not yet tapered | [#2828](https://github.com/benhook1013/FireMUD/pull/2828) | Four fresh whole-unit cycles were productive. The final cycle found and corrected duplicate effective script-patch identity admission with a fail-closed V27 migration and atomic owner guard; no post-fix dry cycle was run because Cycle 4 was the instructed hard stop. Live mounted-certificate/Temporal owner calls, mixed PostgreSQL upgrade/concurrency proof, version-scoped Automation content, exact Game Design template/asset mapping, readiness notification, and dedicated ability-schema attestation remain open. |
| 5B-Retention | Retention classes, cleanup, horizons, contraction | Draft candidate; fresh broad review pending | [#2829](https://github.com/benhook1013/FireMUD/pull/2829) | V4 execution/replay/retention work is preserved behind Publication; no substantive fresh Retention review has begun on the linearized candidate. |
