...
| 1B | Admission, session continuity, and reconnect | Three fresh whole-unit passes productive; Overseer report boundary, not tapered or merge-ready | [#2857](https://github.com/benhook1013/FireMUD/pull/2857) | Stacked on #2856, the draft removes synthetic/unowned `PLAY` actor selection, keeps unqualified `CHARS` unavailable, contains non-public discovery, protects authenticated lobby identity after denied `PLAY`, and separates fresh first-party `LOOK` from retained replay. The latest published CI executed all 39 Game Session cross-service cases green; 22 integration failures are attributable to incomplete actor fixtures and one to an inherited V2 index-name assertion. Local Docker tests skipped. Account's typed runtime readers, Entity namespace/policy roster, durable logout/resume episode, and namespace-scoped controller remain activation successors. No admission-readiness or corpus-closure claim. |
