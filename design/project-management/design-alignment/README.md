...
| 5C | Redis roles and cache/rate-limit semantics | Active in combined 5C/5D successor | Pending publication | The successor consumes the preserved #2661 Redis role, authority, reset, recovery, keyspace, and operational content on exact final #2829. Fresh whole-unit corrected-state review follows baseline publication. |
| 5D | Idempotency, outbox, replay, saga, and workflow patterns | Active in combined 5C/5D successor | Pending publication | The same successor consumes #2661's replay, effect identity, scheduler, tick, saga, workflow, and recovery content. Pending ADR 0183 is preserved without acceptance or proposal-dependent implementation. |
