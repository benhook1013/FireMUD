...
flowchart LR
    ...
    APPLY -->|merged to develop| APPLIED_DECISIONS[125 applied decision keys, including complete Packets 3-4 and the Packet 5 connection/output lane, plus owning design changes]:::status
    APPLIED_DECISIONS -. explains; does not replace .-> ARCH
    APPLY -->|reviewed; pending selective import| PENDING[57 active decision keys pending selective import, including remaining Packet 5 lanes and Packets 6-7]:::pending
