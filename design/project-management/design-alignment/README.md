...
| --- | --- | --- | --- | --- |
| 1A | Identity, entitlement, and hosted terms | Cycle 9 dry; one-cycle dry streak | [#2840](https://github.com/benhook1013/FireMUD/pull/2840) | The refreshed manifest adds the Account service owner README and current AA-1 ADRs to the recovered 17-source prompt, with named 5A, 1B, 5B/5D, 3A, 6A/6B/6C, platform, and billing handoffs. Cycles 1–8 were productive (`16/1`, `24/1`, `18/1`, `33/1`, `13/1`, `17/1`, `47/3`, `28/3` raw/useful). Cycle 9 found no new useful obligation; registration-created membership, exact workload binding, complete membership/entitlement evidence, explicit JOIN, provider lifecycle, retention, outbox, hosted-terms, and migration proof gaps remain explicitly routed. One corrected-state dry cycle does not establish taper; a second consecutive dry cycle is required. |
