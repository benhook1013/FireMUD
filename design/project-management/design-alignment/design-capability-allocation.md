...
| [Architecture decision registry](../../architecture/decisions/README.md) | Registry plus 180 ADRs | Per-record allocation | Per-record affected capabilities | Decision record | The registry is an index; reviewed, accepted, superseded, and withdrawn records remain distinguishable |
