...
- Focused Account-failure evidence already exists in [`FriendServiceImplTest`](../../../services/social-groups-service/src/test/java/unit/net/firedevops/firemud/socialgroups/service/impl/FriendServiceImplTest.java) (`listFriendPresenceFailsClosedWhenAccountPolicyBatchIsUnavailable`, lines 737-770) and [`AccountClientTest`](../../../services/social-groups-service/src/test/java/unit/net/firedevops/firemud/socialgroups/client/AccountClientTest.java) (`recordsApplicationErrorsFromPresenceVisibilityPolicyReads`, lines 104-119). No duplicate Social & Groups test was added. The existing service proof maps missing Account policy to `PRIVATE` and strips location/character fields, but its assertion that `online` remains true leaves the stronger no-presence-fact redaction proof gap tracked rather than claiming it complete.
