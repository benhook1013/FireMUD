...
- `MS-SOCIAL-PRESENCE-PRIVACY`: [ADR 0046](../../architecture/decisions/adr-0046-bounded-friend-presence-with-private-by-failure-redaction.md) already specifies immutable-snapshot scanning through omitted/redacted candidates until page fill or exhaustion, no entries/token on scan-cap failure, and zero-entry success only at exhaustion.
- Focused Account-failure evidence exists in [`FriendServiceImplTest`](../../../services/social-groups-service/src/test/java/unit/net/firedevops/firemud/socialgroups/service/impl/FriendServiceImplTest.java) (`listFriendPresenceFailsClosedWhenAccountPolicyBatchIsUnavailable`) and [`AccountClientTest`](../../../services/social-groups-service/src/test/java/unit/net/firedevops/firemud/socialgroups/client/AccountClientTest.java) (`recordsApplicationErrorsFromPresenceVisibilityPolicyReads`). The service now normalizes missing, unknown, malformed, and unavailable Account policies to the `PRIVATE` redacted shape, including false `online` and null location, character, activity, last-seen, and disconnect fields, while retaining the valid roster/count shape; the focused assertion establishes this boundary as proof complete.
...
- [x] `MS-AA-TOKEN-REVOCATION` — `superseded` on 2026-07-19 by the human-approved [AUTH-03](./decision-inventory-cross-cutting.md#identity-admission-and-tenancy), [JWT-01](../../architecture/decisions/adr-0035-single-record-issued-token-registry.md), [JWT-02](../../architecture/decisions/adr-0036-monotonic-authority-generations-for-bulk-token-revocation.md), [JWT-03](../../architecture/decisions/adr-0037-fail-closed-token-authority-outages-with-bounded-active-gameplay.md), and [JWT-04](../../architecture/decisions/adr-0038-explicit-jwt-profiles-and-mtls-workload-identity.md) decisions; retained as a historical service-scan alias.
