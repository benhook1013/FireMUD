...
- [**task-list-readiness-follow-up.md**](./task-list-readiness-follow-up.md) – Temporary follow-up checklist for readiness tightening after the initial `LOGIN` + `LOOK` critical-path overhaul.
