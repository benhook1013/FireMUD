...
- reconnect and later cutover flows still need to consume the same persisted pointer truth directly instead of assuming older runtime-local selectors or stale pre-cutover session bindings;
