...
- the current pointer audit seam is authoritative and now has first operator-facing tooling, but reconnect/cutover proof still needs to be broadened beyond the already-hardened first-party login and bootstrap paths.
