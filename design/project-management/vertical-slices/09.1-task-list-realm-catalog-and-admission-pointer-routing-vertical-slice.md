...
- [ ] Broaden runtime-change verification beyond the now-covered connect-token, verified login, reused-session relogin failure, `PLAY`, and active gameplay-stage command seams.
