...
- reconnect and later cutover flows still need to consume the same persisted pointer truth directly instead of assuming older runtime-local selectors;
...
- expand the operator-facing cutover/mutation tooling around the now-live persisted pointer and audit seam.
