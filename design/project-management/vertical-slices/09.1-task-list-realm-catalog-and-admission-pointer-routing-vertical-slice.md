...
- [ ] Broaden runtime-change verification beyond the now-covered connect-token, verified login, reused-session relogin failure, websocket reused-transport route or selector refresh, `PLAY`, stale-shell presence cleanup, and active gameplay-stage command seams.
