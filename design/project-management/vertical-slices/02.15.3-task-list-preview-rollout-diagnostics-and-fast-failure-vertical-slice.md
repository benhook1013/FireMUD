...
Make hosted preview fail faster and explain itself better so preview debugging does not depend on waiting blind through long Helm timeouts. Status: planned.
...
- Fast-failure visibility is especially important while preview still has scoped implementation exceptions such as temporary plaintext internal gRPC.
