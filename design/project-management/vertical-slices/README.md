...
- [02.8-task-list-game-logic-restart-invisibility-vertical-slice.md](./02.8-task-list-game-logic-restart-invisibility-vertical-slice.md) – Follow-up slice for Game Logic restart invisibility once command/tick ownership can be reconstructed from shared state without a visible reconnect.
