...
- [02.5-task-list-non-edge-failover-invisibility-vertical-slice.md](./02.5-task-list-non-edge-failover-invisibility-vertical-slice.md) – Shared-state prerequisite slice for externalizing reconnect-critical coordination so same-type instances can take over safely later.
