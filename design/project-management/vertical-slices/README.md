...
- [02.7-task-list-process-restart-invisibility-vertical-slice.md](./02.7-task-list-process-restart-invisibility-vertical-slice.md) – Follow-up slice for real Game Session and Game Logic process-restart invisibility on top of the live Gateway bridge.
