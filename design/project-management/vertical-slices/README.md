...
- [02.9-task-list-platform-settings-model-vertical-slice.md](./02.9-task-list-platform-settings-model-vertical-slice.md) – Planned cross-cutting settings slice to define the layered platform config model, operator-versus-tenant ownership, and generated settings documentation before `06` adds more gameplay policy.
- [02.10-task-list-communication-and-prompt-settings-vertical-slice.md](./02.10-task-list-communication-and-prompt-settings-vertical-slice.md) – Planned settings follow-up for communication defaults, prompt behavior, and prompt delivery policy.
- [02.11-task-list-look-and-transcript-settings-vertical-slice.md](./02.11-task-list-look-and-transcript-settings-vertical-slice.md) – Planned settings follow-up for `LOOK`, reconnect screen-buffer policy, and transcript rendering defaults.
- [02.12-task-list-movement-and-topology-settings-vertical-slice.md](./02.12-task-list-movement-and-topology-settings-vertical-slice.md) – Planned settings follow-up for movement policy and topology-dependent behavior such as future scope-sensitive communication.
