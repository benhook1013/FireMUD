...
- the new RPC path still needs compile/test validation across proto generation and service wiring;
- the moderation path still exists beside it and needs clean separation proof in tests;
- any remaining callers that conceptually mean “record an event” instead of “moderate/delete” still need to be audited.
...
- [ ] Audit the repo for any remaining “log through moderation” callers and move them to the non-destructive path.
