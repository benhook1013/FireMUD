...
2. [09.3 Realm-Scoped Character and Playable State Policy](./09.3-task-list-realm-scoped-character-and-playable-state-policy-vertical-slice.md)
   Remaining: continue the now-live scope-aware roster, inventory/equipment/container/room-item/friend API guardrails, shared scoped-character resolver, scoped progression/activity mutation guard, first-class scoped scripting ingress/work-item/schedule/read-model propagation, and now scope-aware account/friend presence read models into later loadout, ability, authored-effect, and richer resource-table gameplay-state families without reintroducing tenant-wide shortcuts.
