...
3. [09.3 Realm-Scoped Character and Playable State Policy](./09.3-task-list-realm-scoped-character-and-playable-state-policy-vertical-slice.md)
   Remaining: continue the now-live scope-aware roster, inventory/equipment alignment, scoped friend-link guard, and first scoped progression/activity mutation guard into later loadout, ability, and richer resource-table gameplay-state families without reintroducing tenant-wide shortcuts.
