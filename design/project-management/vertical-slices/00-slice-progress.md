...
3. [09.3 Realm-Scoped Character and Playable State Policy](./09.3-task-list-realm-scoped-character-and-playable-state-policy-vertical-slice.md)
   Remaining: continue the now-live scope-aware roster, inventory/equipment alignment, and first scoped progression/activity mutation guard into later loadout, ability, and richer resource-table gameplay-state families without reintroducing tenant-wide shortcuts.
...
2. [09 Multi-Tenancy, Realm Routing, and Runtime Boundaries](./09-task-list-multi-tenancy-realm-routing-and-runtime-boundaries-vertical-slice.md)
   Remaining: the family now has canonical routing, explicit public-production pointer metadata, public-production membership creation, bootstrap/connect-token alignment, scope-aware roster policy, first scoped progression/activity mutation guards, operator-facing admission-pointer/cutover tooling, and gateway-routed operator access; the next honest work is broader admission-pointer consumers plus later loadout/ability/resource-table follow-through.
