...
- implement connect-scope invalidation behavior cleanly enough that clients rerun discovery on stale selector errors instead of inventing local fallback routing.
