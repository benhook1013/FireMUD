...
- richer policy consumers beyond those first scripting binding scopes are still future work.
...
- Remaining: extend category/tag truth into broader policy consumers beyond the first scripting binding scopes instead of leaving that metadata usable only at ingress binding resolution.
