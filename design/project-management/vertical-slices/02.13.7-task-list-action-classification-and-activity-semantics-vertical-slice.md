...
- richer policy consumers of those tags are still future work.
...
- Remaining: add real tag consumers in later scripting/policy work instead of leaving tags as metadata only.
