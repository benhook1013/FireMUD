...
- Remaining: extend category/tag truth into broader policy consumers beyond the first scripting and classic text-rendering seams instead of leaving that metadata usable only at ingress binding resolution.
