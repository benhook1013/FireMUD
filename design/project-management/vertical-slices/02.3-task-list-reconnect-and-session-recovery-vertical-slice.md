...
- Broader restart invisibility for non-edge services remains open even though edge-boundary classification is now substantially exercised.
...
- Additional operator-facing synthesis may still be useful later, but the basic per-class counters are now present and tested.
