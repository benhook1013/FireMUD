...
- implement the now-documented `automation:queue:{tenantInstanceTag}:*` catalog, per-command `automationDispatchId` mapping, and bounded handoff outcome mapping in the owning services and tests.
