...
- extend the first production executor beyond the current bounded condition/command-template format toward richer graph/runtime output without changing the handoff identity seam.
