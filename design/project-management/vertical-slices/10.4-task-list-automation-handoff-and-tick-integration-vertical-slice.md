...
- keep hardening queue lifecycle and rebuild proof so `automation:queue:*` remains a reset-tolerant derived index rather than an unbounded alternate source of work truth as richer statuses and consumer paths land.
