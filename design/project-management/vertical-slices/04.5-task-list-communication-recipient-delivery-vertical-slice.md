...
- [x] Ensure Game Session consumes structured recipient views from Game Logic instead of inventing target/observer prose locally.
...
- Recipient-side delivery currently targets actor-selected gameplay sessions in the same gameplay instance and appends the rendered text into that recipient's reconnect screen buffer.
