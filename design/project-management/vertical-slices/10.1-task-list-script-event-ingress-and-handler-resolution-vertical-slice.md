...
- complete runtime consumption of the durable `script_work_items` outbox after binding resolution.
...
- [ ] Implement the slice end to end.
  ...
  - [ ] Runtime work-item consumption and downstream execution remain to be implemented.
