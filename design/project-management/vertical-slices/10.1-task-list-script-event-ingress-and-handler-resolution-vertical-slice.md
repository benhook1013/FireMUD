...
- implement the now-documented custom-event registry enforcement, explicit `readSnapshotToken` handling, and event-scope admission vocabulary in real ingress APIs and tests.
