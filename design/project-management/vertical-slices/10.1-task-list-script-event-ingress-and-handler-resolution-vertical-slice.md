...
- extend real producer coverage beyond the now-live Game Session `onCommand`, movement lifecycle, and scheduler/timer paths into additional gameplay lifecycle events.
