...
- [ ] Extend real producer coverage beyond the now-live Game Session `onCommand`, fresh-PLAY `onSpawn`, direct `LOGOUT` room exit, movement lifecycle, and scheduler/timer paths into additional gameplay lifecycle events.
