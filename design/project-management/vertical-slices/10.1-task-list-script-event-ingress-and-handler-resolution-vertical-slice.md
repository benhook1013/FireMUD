...
- [ ] Carry the same runtime-activation truth beyond the now-converged ingress/replay path into any later plugin-owned follow-up readers that would otherwise fall back to weaker request- or publication-shaped assumptions.
