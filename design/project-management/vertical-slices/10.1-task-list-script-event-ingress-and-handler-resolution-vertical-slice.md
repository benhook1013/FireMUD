...
- carry the now-live gameplay routing bundle beyond the current ingress/work items/handoffs/scheduler path into any later runtime-owned follow-up families where those events become reconnect- or cutover-sensitive.
