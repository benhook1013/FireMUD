...
- [ ] Migrate `automation-scripting-service`.
  Current pass: the service's highest-leverage queue/projection/runtime-state plus audit/history persistence seam is now on `jOOQ`; remaining JPA surface is narrower and explicitly tracked in `02.19.2`.
