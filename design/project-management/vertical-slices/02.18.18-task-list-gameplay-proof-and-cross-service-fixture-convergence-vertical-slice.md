...
- [x] Close the narrower residual gameplay-proof debt that had been tracked in [`02.18.18.1`](./02.18.18.1-task-list-gameplay-transcript-and-baseline-proof-hardening-vertical-slice.md) at the current boundary.
