...
- additional future migrations onto the shared reconnect/takeover helpers when later gameplay suites are added;
- optional deeper smoke transport-driver convergence if it can be done without weakening the current operator-facing black-box shape.
