...
Goal: collapse duplicated Redis reset/recovery command sequences into one normative sequence plus scenario-specific deltas so operational runbooks do not drift. Status: planned.
