...
Turn pull-request preview from render-and-validate infrastructure into a real reviewer-usable hosted environment, with manual proof focused first on `LOGIN -> PLAY -> LOOK` over the TCP Proxy Service.
