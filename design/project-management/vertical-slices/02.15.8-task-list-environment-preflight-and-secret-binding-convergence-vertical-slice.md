...
- The preflight expected-binding validation now checks rendered secret mounts for JWT/JWKS wiring, but it should continue to tighten against richer Kubernetes live-state evidence as that becomes available.
