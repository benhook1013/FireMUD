...
- no known gameplay-facing start path is still bypassing the canonical gRPC admission seam; future non-gRPC paths should stay explicitly non-canonical unless they fully delegate.
