...
- no known gameplay-facing start path is still bypassing the canonical gRPC admission seam; keep future non-gRPC paths explicitly non-canonical unless they fully delegate.
