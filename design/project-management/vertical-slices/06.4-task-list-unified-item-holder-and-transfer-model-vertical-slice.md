...
- the underlying backend holder/storage model is still only partially unified because container contents remain aggregated and transfer audit semantics are not yet expressed as one canonical holder-transfer contract.
