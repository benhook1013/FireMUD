...
- [ ] Define the exact guarded-handoff precondition/audit contract for retries, stale source ownership, and duplicate execution attempts.
...
- [ ] Prove the guarded-handoff semantics are strong enough to prevent classic duping/loss failures under stale source ownership or duplicate execution.
