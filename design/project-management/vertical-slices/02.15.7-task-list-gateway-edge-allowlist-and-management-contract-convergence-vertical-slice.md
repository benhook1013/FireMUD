...
- [ ] Keep test fixtures honest with the canonical public allowlist so lightweight route fixtures do not silently under-cover the documented external route-family contract.
