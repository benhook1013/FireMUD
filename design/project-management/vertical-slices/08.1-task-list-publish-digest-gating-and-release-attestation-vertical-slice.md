...
- downstream consumers still need broader proof coverage beyond the first canonical launch/repair paths, but missing-attestation and unsupported-attestation hard-fail behavior is now grounded in code.
...
- prove any remaining downstream consumers of the release bundle continue to fail closed on missing or unsupported attestation state.
