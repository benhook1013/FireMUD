...
- focused unit and websocket integration coverage exists for the basic logout path, replay-buffer cleanup, and the distinction between later fresh login and reconnect/takeover counters.
