...
- [x] Replace the completed constructor-cleanup seams with service-local test builders, fixture factories, or narrower collaborator injection so tests no longer require production constructors to manufacture config defaults.
  Remaining: [GameSessionControlPlaneGrpcService.java](../../../services/game-session-service/src/main/java/net/firedevops/firemud/gamesession/service/impl/GameSessionControlPlaneGrpcService.java) still carries this smell and needs the same treatment during its later decomposition.
