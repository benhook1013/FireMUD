...
- [ ] Keep all future public-production checks anchored to the now-live Game Session admission-pointer authority rather than reintroducing local config or caller-guessed routing.
