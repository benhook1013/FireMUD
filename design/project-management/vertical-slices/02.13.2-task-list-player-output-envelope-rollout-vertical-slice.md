...
- Some narrower seams still store or transmit pre-rendered protocol text, but the main admission, world-browse, room-refresh, and direct communication actor paths no longer do.
