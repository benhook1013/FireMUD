...
- Some command handlers still return pre-rendered protocol text in narrower transitional paths, but the active room-refresh seam is no longer one of them.
