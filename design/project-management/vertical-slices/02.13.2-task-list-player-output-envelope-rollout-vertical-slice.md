...
- The remaining transitional seams are now concentrated around compatibility helpers and older test-oriented response-text accessors rather than the main built-in command handlers.
- Some narrower transitional paths still return pre-rendered protocol text, but the main admission, world-browse, room-refresh, and direct communication seams no longer do.
