...
Add a canonical local reset-and-rebuild toolchain that can destroy local runtime state, rebuild the stack from migrations and seed/bootstrap state, and prove a narrow gameplay happy path without relying on hand-driven cleanup. Status: partially implemented.
