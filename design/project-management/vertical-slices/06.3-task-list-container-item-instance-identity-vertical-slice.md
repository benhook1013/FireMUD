...
- [x] Prove that `CONTAINER`, `PUT`, `TAKE`, `DROP`, `GET`, `WEAR`, and `REMOVE` continue to act on the correct concrete item instance when duplicates exist for the currently durable container-instance-backed item class.
