...
Goal: stop collapsing physical items by item definition so two identical satchels, swords, potions, backpacks, or chests can exist as distinct things with different locations, different state, and later different per-instance history or effects. Status: partially implemented.
