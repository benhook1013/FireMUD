...
- [ ] Extract reusable multi-actor scenario helpers for actor/target/observer websocket flows.
...
- extract the next layer of websocket/telnet scenario helpers for actor/target/observer and reconnect-readiness shapes;
