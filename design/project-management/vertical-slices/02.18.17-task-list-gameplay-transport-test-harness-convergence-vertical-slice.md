...
- [ ] Extract repeated backend request-shape assertions where multiple chained-flow suites verify the same communication/inventory/equipment semantics.
...
- then extract shared backend assertion helpers rather than expanding transport-local assertion idioms further.
