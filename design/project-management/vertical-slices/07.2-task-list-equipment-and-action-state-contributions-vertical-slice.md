...
- The first equipment proof supports passive resource/stat contributions such as `armour_value` or resistances; it does not yet include final creator-facing authoring UI, transient action-state lifecycle, or combat consumption.
