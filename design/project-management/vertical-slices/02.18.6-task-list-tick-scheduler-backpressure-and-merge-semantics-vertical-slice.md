...
Goal: finish the remaining runtime-hardening gap by making tick scheduling bounded, observable, and safe under executor pressure without introducing a dedicated queue/lease scheduler. Status: implemented pending operator proof.
...
- preview/prod-like operator proof of the chosen initial thresholds;
