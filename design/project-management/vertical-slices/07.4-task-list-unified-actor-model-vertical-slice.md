...
- The actor core records tenant/game-instance context, `actorKind`, display name, presence state, targetability state, and visibility state. Actor variants add their player-character or NPC-runtime-instance linkage without changing that core.
