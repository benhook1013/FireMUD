...
7. **Live Backend Rebind Invisibility** - The Gateway-owned gameplay bridge, stable edge transport session ids, and focused abrupt-upstream-loss rebind proof are now baseline live in `02.6-task-list-live-backend-rebind-invisibility-vertical-slice.md`; real Game Session and Game Logic process-restart invisibility continue in `02.7-task-list-process-restart-invisibility-vertical-slice.md`.
