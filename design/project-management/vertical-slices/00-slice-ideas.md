...
- **Inventory, Containers, and Equipment** - Build the post-movement item interaction slice around hidden inventory containers, room-attached ground containers, nested containers, first-class equipment bindings, game-configurable slot/body-layout rules, richer inventory queries, and a canonical inventory transfer audit trail for dupe investigation.
