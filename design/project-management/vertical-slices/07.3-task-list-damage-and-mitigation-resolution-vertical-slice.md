...
Define the later combat-facing slice that consumes the shared stats, conditions, and effect engine to resolve damage, mitigation, resistances, and action-gated defenses deterministically.
