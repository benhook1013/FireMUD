...
- Current effective-config behavior is now explicit:
  - communication defaults resolve directly in Game Logic from `CommunicationProperties`;
  - prompt defaults resolve directly in Game Session from `PresentationProperties`;
