...
- Pre-`06` completion note:
  - only the agreed first bounded subset of communication defaults is surfaced and enforced here; broader communication modes and topology-sensitive scope remain later slices by design;
  - tenant/game override resolution beyond the current bounded shared authority/caps model remains future work outside this slice; and
