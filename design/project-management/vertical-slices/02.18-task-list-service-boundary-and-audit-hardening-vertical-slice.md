...
- `02.18.17` now owns convergence of chained gameplay WebSocket/Telnet proof onto shared FireMUD transport drivers instead of continuing to grow ad hoc test-local socket loops.
