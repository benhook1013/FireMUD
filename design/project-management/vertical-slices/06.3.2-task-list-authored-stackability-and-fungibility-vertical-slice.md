...
- no stack merge/split behavior exists yet, so the runtime still treats all current items as distinct physical instances unless later holder/query work opts into stack behavior.
