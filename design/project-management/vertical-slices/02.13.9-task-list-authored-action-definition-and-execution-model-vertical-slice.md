...
- add the first non-built-in command-definition provider and prove it executes through the same parser/registry/dispatch architecture;
...
- Define how authored command phrases/aliases map to action identity through the existing registry seam without creating a parallel parser architecture.
