...
- admitted authored definitions carry `TextCommandType.AUTHORED`, canonical `commandId`, aliases, stage, prompt policy, action category, ordered action-admission tags, and authored source ownership;
