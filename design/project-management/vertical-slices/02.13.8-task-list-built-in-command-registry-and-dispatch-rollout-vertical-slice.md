...
- expand command definitions into the shared classification/ownership seam before authored commands arrive;
...
4. Add action classification and ownership/source metadata to command definitions.
