...
- [x] Keep later producer families and richer runtime evaluators on the same bounded execution-policy contract instead of reopening request-local quota, budget, freshness, or isolation policy.
