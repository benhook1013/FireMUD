...
- [ ] Extend operator metrics beyond the current durable work-item outcome counter, which now already breaks outcomes down by `sourceKind`, `sourceService`, `eventType`, `priorityTag`, and `dryRun`, into broader dashboards and alerting as more producers land.
