...
- implement and wire the remaining now-documented pin-freshness and signer-policy-freshness knobs into the owning runtime paths; outbox-retention cleanup, serialized work-item payload-size rejection, and first command-count output ceilings are now live.
