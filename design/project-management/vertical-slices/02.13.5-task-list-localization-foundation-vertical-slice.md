...
- Authored room prose now has a first runtime path on `LOOK` and movement refresh. Item/world/lore adoption is still future work and should keep using stored localized variants rather than live translation.
