...
- account-profile presence policy contract in `services/account-service/src/main/java/net/firedevops/firemud/accountservice/repository/Profile.java` and `services/account-service/src/main/java/net/firedevops/firemud/accountservice/service/impl/AccountServiceImpl.java`
