...
What remains open is wider replacement-instance/cutover consumers beyond the explicit stop/termination path, the remaining launch failure vocabulary around remap requirements and later patch/readiness cases, and fuller instance-topology materialization beyond the now-live `world_instance` / starter `region_instance` substrate.
