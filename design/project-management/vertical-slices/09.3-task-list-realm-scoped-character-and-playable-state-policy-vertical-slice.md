...
- downstream gameplay-state namespaces beyond the character/inventory/equipment namespace still need the same realm-policy rollout;
- the next honest follow-through is the progression/resources/loadout family rather than reworking inventory/equipment again.
...
- keep progression/resources/loadout and later gameplay-state families on the same resolved playable-state namespace rather than reintroducing tenant-wide shortcuts.
