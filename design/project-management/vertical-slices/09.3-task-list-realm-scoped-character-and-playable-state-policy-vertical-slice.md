...
- the next honest follow-through is later loadout, ability, authored-effect, and richer resource-table families as they become real rather than reworking the item APIs again.
...
- keep later loadout, ability, authored-effect, resource-table, and gameplay-state families on the same resolved playable-state namespace rather than reintroducing tenant-wide shortcuts.
