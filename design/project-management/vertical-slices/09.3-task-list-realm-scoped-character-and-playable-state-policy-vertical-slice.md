...
- [ ] Keep later loadout, ability, authored-effect, resource-table, and other future gameplay-state families on the same resolved playable-state namespace rather than reintroducing tenant-wide shortcuts as those families land.
