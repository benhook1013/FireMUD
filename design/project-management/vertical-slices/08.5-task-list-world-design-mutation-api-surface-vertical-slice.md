...
- The remaining gap is breadth, not the foundational seam: broader scope-targeted generation payloads and broader editor caller rollout still remain on top of the live contract.
...
- Extend generation writes beyond the first aggregate-level seam into broader scope-targeted payloads such as explicit subtree replace/append flows.
- Broaden the mutation surface beyond scope-validated topology and spawn-binding enforcement into richer generation payload breadth and broader caller adoption.
