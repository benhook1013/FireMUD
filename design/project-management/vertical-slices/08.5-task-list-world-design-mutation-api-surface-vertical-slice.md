...
- Full module `:check -PfullCheck` still hits pre-existing unrelated SpotBugs debt in both services outside this slice, but the canonical `08.5` mutation, digest, and caller surfaces are green.
