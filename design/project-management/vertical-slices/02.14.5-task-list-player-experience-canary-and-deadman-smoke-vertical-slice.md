...
What remains open is the runtime producer side: actual canary/blackbox/deadman signal producers and controlled non-production failure injection still need to land before this slice is end-to-end executable.
