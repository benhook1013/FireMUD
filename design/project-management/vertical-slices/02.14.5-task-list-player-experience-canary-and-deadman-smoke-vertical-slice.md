...
What remains open is the runtime producer side: actual canary/blackbox/deadman signal producers and controlled non-production failure injection still need to land before this slice is end-to-end executable. That remaining work is intentionally paused until the repo has concrete decisions for public endpoint targets, synthetic account/realm/character provisioning, the external deadman authority, and non-production failure-injection routing that cannot page production destinations.
