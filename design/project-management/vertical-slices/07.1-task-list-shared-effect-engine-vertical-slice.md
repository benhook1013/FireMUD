...
2. It resolves the typed candidate selector against canonical actor identity and World Management occupancy, then evaluates the declared release-pinned DML `TargetingPolicy` against source/target actor facts and relationship/spatial facts.
