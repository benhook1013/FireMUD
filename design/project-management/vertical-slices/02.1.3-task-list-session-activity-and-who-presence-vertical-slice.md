...
- bounded recent-presence state now also records canonical disconnect disposition (`TRANSPORT_LOSS`, `LOGOUT`, `TAKEOVER`) instead of flattening every transition into one generic `lastSeenAt` write;
