...
- websocket reconnect proof that unexpected disconnect removes live presence immediately, preserves reconnect-eligible session state, and re-establishes live presence on the new transport session.
...
- broader transport/lifecycle proof around presence continuity and recent-presence policy across reconnect, takeover, and logout outcomes.
