...
- [ ] Define explicit AFK command behavior, including future shaped commands such as `AFK`, `AFK ON`, and `AFK OFF`.
- [ ] Define how optional auto-AFK works when enabled by game settings.
- [ ] Document precedence between explicit AFK and auto-AFK.
...
- [ ] Add unit/integration coverage proving presence changes correctly across:
  ...
  - takeover;
  - logout.
- [ ] Add coverage proving activity timestamps and AFK state react correctly to:
  - ordinary commands;
