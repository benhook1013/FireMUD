...
- This slice intentionally stops at the live bridge and focused abrupt-upstream-loss rebind proof. Real Game Session and Game Logic process-restart continuity are split into `02.7-task-list-process-restart-invisibility-vertical-slice.md`.
