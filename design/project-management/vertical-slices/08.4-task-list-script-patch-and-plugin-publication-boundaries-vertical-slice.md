...
- define the first narrow control-plane/API slice for script patch readiness and rollout visibility.
- define the first narrow control-plane/API slice for plugin publication status versus instance activation state.
- ensure publish/status docs and future implementation avoid collapsing publication and activation into one state machine.
