...
- finish the remaining Automation activation gates beyond the now-live publication, `baseVersionId`, and immutable runtime `abilitySchemaDigest` validation: signer/component policy enforcement still remains.
