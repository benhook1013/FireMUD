...
- `bash dev-tools/check-grpc-transport-config.sh --enforce` now passes, proving no service runtime config files still use the legacy server-TLS property shape.
