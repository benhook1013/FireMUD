...
Replace the repository's older gRPC server TLS property pattern with the Spring gRPC `1.0.x` SSL-bundle model so internal gRPC mTLS is configured correctly and consistently across services. Status: partially implemented.
