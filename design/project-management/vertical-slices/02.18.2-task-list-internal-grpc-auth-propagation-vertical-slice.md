...
- decide whether the remaining intentional raw blocking clients such as `TcpProxyEventClient` should stay distinct or also adopt the same seam later.
...
- [ ] Decide whether the remaining intentional outliers should adopt the same pattern as those boundaries harden.
