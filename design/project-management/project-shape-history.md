...
The recommended response is to resolve known drift first, then finish selected high-value capabilities end to end, prioritizing playable user journeys over additional broad substrate. This dated entry preserves the complete July 17 counts. The frozen [August 5 capability implementation reconciliation snapshot](./design-alignment/capability-implementation-reconciliation.md) is a later baseline with different counts; active current gaps remain in the domain trackers.
