...
- **Identity and scoping**
  - Each follow-up is tied to a specific target region timeline and effect identity, including at minimum:
    ...
    - `tenant_id`, `target_game_instance_id`, `target_playable_state_namespace_id`, resolved `playable_state_scope`, `target_region_id`, `target_region_epoch`
