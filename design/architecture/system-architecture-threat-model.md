...
The human-led design process will decide when this work is wanted and what review method it uses. Until then, absence of an item here must not be interpreted as evidence that the risk was assessed or accepted.

## Related Current Contracts

- [Security architecture](./system-architecture-security.md)
- [Authentication and session handling](./system-architecture-authentication.md)
...
- [Infrastructure environment and secrets](./infrastructure/environment-and-secrets.md)
