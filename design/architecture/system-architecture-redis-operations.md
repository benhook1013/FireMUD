...
- **Unreplicated coordination-write window**
  ...
  - a sustained breach is a coordination SLO violation: automation must widen durable reconstruction/terminalization checks and report affected command, effect, retry, and correctness-timer counts
