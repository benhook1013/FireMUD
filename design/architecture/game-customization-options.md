...
- The React client loads theme and asset files per tenant at runtime; see [Frontend Architecture](./system-architecture-frontend.md).
- Optional layout tweaks can be enabled via [runtime feature flags](./microservices/game-design-service/feature-flags.md) defined in the Game Design Service and toggled through the [Logging & Admin Service](./microservices/logging-admin-service/README.md).
