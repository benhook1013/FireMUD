...
| `automation:test:capacity:<tenantId>:*` | **Cache/Rate-Limit Redis** | Automation & Scripting Service | Best-effort dry-run/test capacity counters and leases. Safe to drop; leases are bounded and protect test traffic from starving live automation. |
