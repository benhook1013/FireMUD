...
| `AUTOMATION_TICK_BUDGET_MS` | Cumulative estimated-millisecond reservation budget for deterministic ordered-prefix admission in one automation tick; excess work is deferred | `100` | Advanced/experimental |
