...
- Read-model ownership for Automation status is a bounded, idempotent projection of Game Session pin mutations keyed by `controlPlaneRequestId`; it remains replaceable, non-authoritative, and never derives rollout history locally.
