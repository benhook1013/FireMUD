...
- `GetScriptStatus` – queries whether a script has durable queued work (`PENDING_EVALUATION`) or active evaluation work (`EVALUATING`) in the script work-item outbox.
