...
2. **Profanity Filtering** – common swear words are automatically masked by the Social & Groups Service. Chat profanity events are reported to the Logging & Admin Service for audit purposes. Word lists cannot yet be customized per tenant. See the [Social & Groups Service design](../social-groups-service/README.md) for filter details. (TODO: Not yet implemented for custom lists)
