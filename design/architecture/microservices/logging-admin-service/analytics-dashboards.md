...
- **Service Overview** – CPU, memory, and request rates for each microservice. See [`service-overview.json`](../../../observability/grafana/service-overview.json). (TODO: Not yet implemented)
...
- **Log Volume** – ingest rates, log levels, and error hotspots. See [`log-volume.json`](../../../observability/kibana/log-volume.json). (TODO: Not yet implemented)
