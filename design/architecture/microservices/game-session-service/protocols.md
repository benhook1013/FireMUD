...
- `WORLD_ACCESS_DENIED` – current runtime behavior for a private, playtest, or other non-public target whose caller membership is missing or not `ACTIVE`; no public join action is offered.
