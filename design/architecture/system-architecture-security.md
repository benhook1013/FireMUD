...
- During the interim fallback, Account may reload validated signing material when mounted files change; malformed or mismatched material leaves the old signer active and fails readiness. The file watcher is implementation plumbing, not a second rotation contract.
