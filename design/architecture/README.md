...
| Durable per-dispatch script handoff and stage-qualified outcomes | [Scripting cross-service contracts](./system-architecture-scripting-contracts.md) | Script work-item storage, dispatch/result reads, and operator projections | 0063, 0064 |
