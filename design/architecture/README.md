...
| JWT issuance, registry identity, profiles, authority generations, outage validity, and key rotation | [JWT and token contracts](./system-architecture-jwt-and-token-contracts.md) | Route carriage and service-local validation consequences | 0014, 0035-0038 |
...
| Authentication, membership admission, `JOIN`, and gameplay identity binding | [Authentication](./system-architecture-authentication.md) | Account-owned mutations and Game Session translation | 0021, 0022, 0024, 0025, 0026, 0040, 0042, 0045 |
...
| Tenant identity, isolation, authority generations, and realm admission pointers | [Multi-tenancy](./system-architecture-multi-tenancy.md) | Service-owned tenant data and routing consequences | 0027, 0041 |
| Membership and runtime entitlement authority | [Account runtime and data](./microservices/account-service/runtime-and-data.md#membership-and-entitlement-authority) | Consumer-side entitlement enforcement | 0028 |
