...
| Control-plane notifications, owner-read recovery, and targeted durable transport | [Scripting control-plane events](./system-architecture-scripting-control-plane-events.md#targeted-durable-delivery) | Event-family payloads, owner state/history reads, advisory reread wake-ups, targeted producer/consumer outbox adoption, reconstruction APIs, and service-local backpressure consequences | 0083, 0120 |
