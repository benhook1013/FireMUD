...
| Tenant identity, isolation, and realm admission-pointer identity/authority | [Multi-tenancy](./system-architecture-multi-tenancy.md) | Service-owned tenant data and routing consequences | 0027, 0041 |
