...
| Class-specific timer durability and recovery | [Scripting scheduler and timers](./system-architecture-scripting-scheduler-and-timers.md) | Timer persistence, reload/recovery policy, and tick scheduler integration | 0072 |
