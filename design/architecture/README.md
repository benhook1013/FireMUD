...
| Durable asynchronous event transport and general-broker adoption gates | [Scripting control-plane events](./system-architecture-scripting-control-plane-events.md#durable-transport-authority) | Event-family payloads, producer/consumer outbox adoption, reconstruction APIs, and service-local backpressure consequences | 0083 |
