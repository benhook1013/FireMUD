...
| SQL persistence stack, service-owned schemas, migration compatibility, and identifier migration | [Database migrations](./system-architecture-database-migrations.md) | Shared-library helpers and service-local persistence, deployment, data-lifecycle, and proof consequences | 0079-0082 |
