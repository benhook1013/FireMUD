...
- Gateway-issued context fields (minimum): `accountId`, `tenantId`, `gameInstanceId`, `worldSlug`, `realmSlug`, `pointerVersion`, `catalogRevision`, `connectScopeId`, `connectTokenJti`, `replayAdmissionFence`, `verifiedAt`, `expiresAt`, `gatewayRequestId`.
