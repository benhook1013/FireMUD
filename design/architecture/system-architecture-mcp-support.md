...
MCP is an extension to Telnet that wraps commands inside structured packages for
client/server automation. FireMUD plans to implement MCP 2.1 for compatibility
with popular MUD clients. (TODO: Not yet implemented)
...
Clients initiate the `#$#mcp` handshake to advertise supported packages. (TODO: Not yet implemented)
...
- [Mud Client Protocol 2.1 Specification](https://github.com/MudMCP/MCP-2.1)
