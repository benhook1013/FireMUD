...
6. Read the backup artifact's erasure-journal high-water, verify the independently retained journal through its current high-water, and idempotently replay every intervening owner-specific erasure or tombstone. A missing sequence, integrity failure, unavailable owner, or incomplete convergence keeps quarantine closed.
