...
- Redis is a rebuildable, non-authoritative projection. Cache loss, expiry, reset, miss, or unavailable Redis must fall back to authoritative Social/PostgreSQL history or rebuild the window from persisted history; it must not change retention, erasure, idempotency, or recipient disclosure.
