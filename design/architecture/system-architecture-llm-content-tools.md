...
See [ADR 0116](./decisions/adr-0116-untrusted-models-and-scoped-authoring-tools.md) for the accepted decision and the [Game Design Service](./microservices/game-design-service/README.md) for the canonical authoring boundary.
...
- No whole-game filesystem, round-trip JSON, or external Git authoring format; see [ADR 0110](./decisions/adr-0110-defer-whole-game-portability-and-external-authoring-formats.md).

## Related Documentation

- [ADR 0116](./decisions/adr-0116-untrusted-models-and-scoped-authoring-tools.md)
