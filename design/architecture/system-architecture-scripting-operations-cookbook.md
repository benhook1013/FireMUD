...
4. Repair and republish.
   ...
   - Verify that the new patch reaches `patchStatus=READY` for the tenant and that `onLoad` initialization succeeds before explicitly pinning its new exact `(scriptPatchVersion, scriptPinEpoch)` tuple again.
