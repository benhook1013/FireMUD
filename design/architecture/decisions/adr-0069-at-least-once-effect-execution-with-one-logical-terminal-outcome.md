...
The accepted decision does not select a generated-child allocator or exact scalar format. Those unresolved target-state questions are recorded, without authority, in the pending [ADR 0183 proposal](./adr-0183-deterministic-effect-id-allocation-and-replay-binding.md).
