# ADR 0160: Staged Profile-Aware Player-Experience SLO Contract
...
The player-experience metric catalog, rules, dashboards, and runbook shapes are partial foundations. Cohesive live-traffic producers, representative profile baselines, minimum-sample handling, calibrated multi-window burn alerts, and focused proof remain gaps.
...
- [design/observability/grafana/player-experience-alerts-snippets.md](../../observability/grafana/player-experience-alerts-snippets.md)
- [design/observability/grafana/player-experience.json](../../observability/grafana/player-experience.json)
- [design/observability/grafana/player-experience-drilldown.json](../../observability/grafana/player-experience-drilldown.json)
- [k8s/monitoring/prometheus-rules-firemud.yaml](../../../k8s/monitoring/prometheus-rules-firemud.yaml)
- [design/architecture/microservices/game-session-service/configuration.md](../microservices/game-session-service/configuration.md)
