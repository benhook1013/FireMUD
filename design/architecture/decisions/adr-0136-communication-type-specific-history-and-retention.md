# ADR 0136: Communication-Type-Specific History and Retention
...
Game Session's bounded reconnect or transcript context remains a separate namespace-scoped presentation facility under [ADR 0130](./adr-0130-bounded-semantic-reconnect-context.md). It is not Social player history, delivery acknowledgement, a missed-message feed, or a moderation archive.
