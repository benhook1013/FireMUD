...
| [ADR 0100](./adr-0100-separate-generation-ingress-with-one-world-owned-engine.md) | Accepted | `AR-1` | `AR-1`, `AR-3`, `GR-2`, `AS-1` | Separate typed design and runtime generation ingress backed by one World-owned pure engine |
| [ADR 0101](./adr-0101-explicit-destructive-regeneration-with-previewed-scope.md) | Accepted | `AR-1` | `AR-1`, `AR-2`, `GR-2` | Historical replay preserves later edits while new destructive regeneration requires an exact bound preview |
| [ADR 0102](./adr-0102-first-class-sparse-and-full-grid-world-topologies.md) | Accepted | `GR-2` | `GR-2`, `AR-1`, `SF-2` | First-class sparse and bounded full-grid topologies with independent movement policy and opaque scalable representation |
