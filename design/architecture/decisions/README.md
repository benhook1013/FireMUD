...
| [ADR 0146](./adr-0146-owner-local-moderation-enforcement.md) | Accepted | `PO-1.2` | `EA-2.4`, `AA-1.3`, `PO-1.3`, `PO-4.1` | Owner-local moderation enforcement through acknowledged typed commands |
