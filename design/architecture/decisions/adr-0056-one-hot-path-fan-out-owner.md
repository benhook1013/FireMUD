...
Current gameplay paths have bounded orchestration seams, but the universal one-owner/transitive two-participant rule, complete stage and retry budgets, and focused nested-fan-out proof are not yet established across every command family. Movement must converge on the ordinary rule; the former movement exception is not a current target contract.
