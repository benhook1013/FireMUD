...
- Fair tenant-local capped catch-up bounds recovery load within each tenant's resume window, while admitted work remains subject to shared scheduler/cluster fairness and ceilings.
