...
The class-specific loss matrix is accepted target state; durable-intent reconstruction, terminalization, and measured environment SLO calibration remain implementation and proof gaps.
