...
- rollback;
- and ordinary instance or realm retirement.
...
- the frozen release tuple and source state pass compatibility and migration or remap requirements;
- and every required runtime owner reports readiness under the same launch or cutover proof.
