...
- premium-balance spending proves explicit confirmation, idempotency, cap enforcement, and an explicit owning-boundary tenant consumption binding with current tenant authorization and exact retry identity, without introducing per-purchase factor prompts or treating an account-scoped balance as tenant authority.
