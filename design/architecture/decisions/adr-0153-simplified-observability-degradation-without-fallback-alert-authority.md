# ADR 0153: Simplified Observability Degradation Without Fallback Alert Authority
...
### Independent Deadman Covers Total Failure

The external deadman and public-path monitoring boundary owns detection of total in-cluster monitoring failure and broad public-edge failure. It remains outside the Prometheus and Alertmanager failure domain and pages independently. An in-cluster Prometheus mirror may aid dashboards when healthy, but it is not the independent detection authority.
...
- The external deadman remains necessary because neither Alertmanager nor Prometheus can authoritatively report its own total failure.
...
- `design/architecture/microservices/logging-admin-service/README.md`
- `design/architecture/microservices/logging-admin-service/admin-ui.md`
- `design/observability/README.md`
- `design/observability/grafana/`
