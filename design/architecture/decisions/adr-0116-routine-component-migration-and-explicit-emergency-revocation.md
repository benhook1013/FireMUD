...
- The authoritative revocation action cancels or isolates affected evaluator workers before they can perform further execution of the revoked component or access protected data governed by it; the separate quarantine-and-replacement requirement for potentially compromised workers remains below.
