...
Trust-profile expiry and emergency identity withdrawal are separate boundaries. Gateway enforces migration and break-glass expiry at runtime by stopping the dedicated listener and terminating its established bridges. Emergency withdrawal of an otherwise unexpired identity follows the human-reviewed [ADR 0184](./adr-0184-emergency-tcp-proxy-identity-withdrawal.md), including its possible availability loss and observed cutoff proof.
