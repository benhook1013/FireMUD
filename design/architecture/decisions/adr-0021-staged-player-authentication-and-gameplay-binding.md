...
- Ensure browser connect-token responses never serialize the token into JavaScript-readable data; non-browser carriage remains an explicitly classified response mode.
