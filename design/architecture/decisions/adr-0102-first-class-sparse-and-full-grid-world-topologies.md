# ADR 0102: First-Class Sparse and Full-Grid World Topologies
...
First-class sparse and bounded full-grid semantics are target state. Current implementation has relational room/exit rows and a persisted spacing multiplier but does not yet provide topology-mode schema, full-grid compilation, immutable chunk/root artifacts, lazy cell resolution, durable base-plus-delta composition, or large-grid proof.
