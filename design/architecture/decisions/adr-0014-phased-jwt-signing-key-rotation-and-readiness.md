...
- Provision fixed Account-owned JWT/JWKS resources and name-scoped Account RBAC; prove `resourceVersion` CAS, projected-volume observation, and absence of rotation-Job write authority.
