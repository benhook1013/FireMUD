...
| Target | Target | Revalidate the complete promotion proof and the exact operation/resource versions; if it passes, CAS the record to `COMMITTED`, otherwise abort to the previous generation. |
