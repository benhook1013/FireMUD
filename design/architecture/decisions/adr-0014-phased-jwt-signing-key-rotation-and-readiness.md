...
- An authority-only outage blocks issuance, fresh admission, `PLAY`, reconnect/resume, and protected operations that require a current authority read. An already-admitted gameplay binding may continue only under its existing validated bounded lease; the lease may not be renewed or extended while authority is unavailable, and expiry ends that continuity exception.
