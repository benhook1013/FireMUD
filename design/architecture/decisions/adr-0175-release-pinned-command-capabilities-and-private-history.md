# ADR 0175: Release-Pinned Command Capabilities and Private History
...
This decision is partially implemented. Platform command capabilities and count-bounded history exist, but release-pinned extension registries, uniform ingress enforcement, age bounds, generation fencing, purge, redaction, and focused proof remain gaps.
