# ADR 0163: Service-Owned Retention Classes with Cross-Service Safety
...
This decision is not implemented. Shared retention-class declarations, owner-local safe garbage collection, cross-service blockers, holds, and focused proof remain gaps.
...
- [design/architecture/system-architecture-scaling-runbook.md](../system-architecture-scaling-runbook.md)
- [design/architecture/system-architecture-testing.md](../system-architecture-testing.md)
- [design/architecture/system-architecture-tick-execution-flows.md](../system-architecture-tick-execution-flows.md)
- [design/architecture/system-architecture-tick-failures-and-operations.md](../system-architecture-tick-failures-and-operations.md)
- [Microservices Responsibility Matrix](../service-responsibility-matrix.md) as the intended canonical location for the service-owner and registered cleanup-participation inventory for classified families once that inventory is populated
- Cross-service governance authority remains with [ADR 0050: Versioned Export, Retention, and Erasure Policy](./adr-0050-versioned-export-retention-and-erasure-policy.md) for the retention registry and erasure policy, [ADR 0043: Global Account Lifecycle and Bounded Erasure Workflow](./adr-0043-global-account-lifecycle-and-bounded-erasure-workflow.md) for account-erasure lifecycle, and [ADR 0149: Communication-Type-Specific History and Retention](./adr-0149-communication-type-specific-history-and-retention.md) for communication retention, legal holds, receipts, and payload minimization; these governance decisions are not replaced by service-local operations guidance.
- [Scaling Runbook: Data Retention and High-Churn Tables](../system-architecture-scaling-runbook.md#data-retention-and-high-churn-tables) defines the target shared classified-family requirements; the canonical per-family owner/cleanup-participation registry and current status inventory are not yet populated. That inventory must include remote coordinator/follow-up/result and reconciliation families as well as local families before cross-service retention compatibility or proof can be claimed. [World Management Runtime and Data](../microservices/world-management-service/runtime-and-data.md), [World Creation Workflow](../microservices/world-management-service/world-creation-workflow.md), and [World Management Operations](../microservices/world-management-service/operations.md) own World’s lifecycle-cleanup execution and acknowledgement, while [Game Session Runtime and Data](../microservices/game-session-service/runtime-and-data.md), [Game Session Operations](../microservices/game-session-service/operations.md), [Entity Management Runtime and Data](../microservices/entity-management-service/runtime-and-data.md), [Entity Management Operations](../microservices/entity-management-service/operations.md), [Automation and Scripting Runtime and Data](../microservices/automation-scripting-service/runtime-and-data.md), [Automation and Scripting Operations](../microservices/automation-scripting-service/operations.md), [Logging and Admin Runtime and Data](../microservices/logging-admin-service/runtime-and-data.md), [Logging and Admin Operations](../microservices/logging-admin-service/operations.md), and [Social and Groups Runtime and Data](../microservices/social-groups-service/runtime-and-data.md)/[Social and Groups Operations](../microservices/social-groups-service/operations.md) own their respective local persistence and cleanup execution under those governance decisions.
