...
This decision is not implemented. Stable UUID realm identity, globally unique world selectors, snapshot-bound lobby ordinals, alias handling, and aligned discovery authorization remain gaps.
