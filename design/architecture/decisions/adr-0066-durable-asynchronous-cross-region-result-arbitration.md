...
Durable follow-up/result ownership and target preconditions remain target state; atomic timeout arbitration, immutable origin outcomes, late-result recording, and linked reconciliation proof are not yet claimed.
