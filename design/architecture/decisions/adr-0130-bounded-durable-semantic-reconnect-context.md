# ADR 0130: Bounded Durable Semantic Reconnect Context
...
Rendered text may remain a derived compatibility representation for Telnet and generic text clients, but canonical structured entries remain the durable source of truth. The reconnect feature does not preserve arbitrary raw bytes, frames, prompts, or unsent transport buffers.
