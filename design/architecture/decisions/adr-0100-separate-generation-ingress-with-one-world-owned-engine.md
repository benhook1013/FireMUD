# ADR 0100: Separate Generation Ingress with One World-Owned Engine
...
One World-owned pure engine with separate typed Draft and runtime ingress is target state. Current generator implementations and registry remain in Automation & Scripting; World Management has a generated Draft mutation path but no implemented World-owned design-generation or runtime-generation API that invokes the engine.
