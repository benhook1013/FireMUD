...
- **Account Lifecycle** – Sign up, account-selected password/email-code login, password resets, linked external accounts, subscriptions, purchases, and account data export/deletion are covered in [Player Journeys – Sign Up](./user-journeys-players.md#1-sign-up), [Player Journeys – Join a Game for the First Time](./user-journeys-players.md#2-join-a-game-for-the-first-time), and [Account Data Export & Deletion](./user-journeys-players.md#9-account-data-export--deletion). These flows rely primarily on the [Account Service](./microservices/account-service/README.md) and [Logging & Admin Service](./microservices/logging-admin-service/README.md).
- **Characters and Gameplay** – Character creation and selection, realm discovery, game switching, room views, item/inventory/equipment commands, and moment-to-moment gameplay are described in [Join a Game for the First Time](./user-journeys-players.md#2-join-a-game-for-the-first-time), [Character Creation & Selection](./user-journeys-players.md#3-character-creation--selection), [Player Login and Gameplay](./user-journeys-players.md#4-player-login-and-gameplay), and [Switch Games or Manage Multiple Games](./user-journeys-players.md#8-switch-games-or-manage-multiple-games). These flows involve the Game Session, Game Logic, Entity Management, Game Design, and World Management services.
