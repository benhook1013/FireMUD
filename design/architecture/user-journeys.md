...
- **Account Lifecycle** – Sign up, login, password resets, two-factor authentication, linked external accounts, subscriptions, purchases, and account data export/deletion are covered in [Player Journeys – Accounts and Recovery](./user-journeys-players.md#1-sign-up) and [Account Data Export & Deletion](./user-journeys-players.md#8-account-data-export--deletion). These flows rely primarily on the [Account Service](./microservices/account-service/README.md) and [Logging & Admin Service](./microservices/logging-admin-service/README.md).
- **Characters and Gameplay** – Character creation and selection, game switching, and moment-to-moment gameplay are described in [Character Creation & Selection](./user-journeys-players.md#2-character-creation--selection), [Player Login and Gameplay](./user-journeys-players.md#3-player-login-and-gameplay), and [Switch Games or Manage Multiple Games](./user-journeys-players.md#7-switch-games-or-manage-multiple-games). These flows involve the Game Session, Entity Management, Game Design, and World Management services.
- **Social Interaction** – In-game chat, friends, and guilds are summarized in [Social Interaction](./user-journeys-players.md#4-social-interaction) and feed into operator moderation flows via the Social & Groups Service and Logging & Admin Service.
