...
1. Game Session receives `LOOK` and allocates the complete requested `CausalReadFence`, including the current `regionId`, from durable region commit authority.
