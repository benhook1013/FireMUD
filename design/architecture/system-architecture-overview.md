...
- Selected packs materialize ordinary stat, condition, action, actor-disposition, feedback, world, and starter-content DML into that Draft version. The resulting rows are game-owned and may be edited, replaced, or removed.
