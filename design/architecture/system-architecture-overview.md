...
- **TCP Proxy Service** accepts Telnet connections and upgrades them to WebSocket for the Gateway. This internal link uses mutual TLS on the Proxy → Gateway hop; see the TCP Proxy Service design’s **Implementation Status** section for any current rollout notes.
