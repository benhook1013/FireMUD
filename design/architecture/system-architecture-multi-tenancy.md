...
- `tenantId` values are string GUIDs generated by the Game Design Service. Migration from numeric IDs is still planned. (TODO: Not yet implemented)
...
- Per-game resource quotas are planned so one tenant cannot exhaust cluster capacity. (TODO: Not yet implemented)
