...
- Durable compromise-rotation operation ID, immutable request digest, committed signer generation, JWKS publication evidence, and proof that the issuer generation advanced exactly once; a same-operation retry must return this evidence without another advance.
