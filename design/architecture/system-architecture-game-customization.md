...
- Equipment slots and body layouts are game-authored versioned vocabulary. Publication fails closed for incomplete schema, bindings, or mappings; runtime validates occupancy against the published digest and replacement cutover supplies an explicit remap under [ADR 0127](./decisions/adr-0127-game-authored-equipment-layouts-with-fail-closed-publication.md). The superseded historical proposal is retained only as [ADR 0130](./decisions/adr-0130-historical-equipment-body-layout-authority.md).
