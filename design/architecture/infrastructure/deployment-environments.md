...
- Canonical baseline `NetworkPolicy` manifests live in
  [`k8s/base`](../../../k8s/base) and are included by the staging and production
  Kustomize overlays. The [`k8s/network-policies`](../../../k8s/network-policies)
  directory documents that baseline policy set.
