...
- `<environment>/preflight/<deployment-ref>.waiver.json`: target-state break-glass waiver records bound to the report's deployment event UUID; not currently executable.
