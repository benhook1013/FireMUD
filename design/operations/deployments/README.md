...
- `hobby-self-hosted/traffic-open/<deployment-ref>/<deployment-event-id>.json`: hobby traffic-open evidence whose stored `deploymentEventId` and `preflightReportPath` match the canonical hobby preflight event and backup-compliance record.
