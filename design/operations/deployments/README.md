...
- `production/traffic-open/<event>-<deployment-ref>.json`: production first-live/reopen evidence bound to the canonical preflight report and environment-wide cold-start recovery record.
