...
1. **Chat Channels** – Account messaging, ordinary guild/group channels, browser social actions, and ordinary account/social mail enter Social & Groups directly after authentication and membership/privacy/moderation checks. Social owns the envelope, applicable history, and delivery state; Game Session owns final delivery to connected gameplay transports.
