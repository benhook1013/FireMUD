...
- [ai-rules-global.md](FireMUD/FireMUD-Design/project-management/ai-rules-global.md)
- [ai-rules-local.md](FireMUD/FireMUD-Design/project-management/ai-rules-local.md)
...
- Keep documentation organized within `FireMUD-Design`.
